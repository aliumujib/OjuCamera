...
public abstract class BaseOjuCamActivity<CameraId> extends OjuCameraActivity<CameraId>
        ...
        CameraSwitchView.OnCameraTypeChangeListener, CameraControlPanel.SettingsClickListener, CameraControlPanel.PickerItemClickListener, GalleryClickListener {
    ...
    protected boolean showPicker = false;
    protected int type = CameraConfiguration.PHOTO_AND_VIDEO;
    ...
    @Override
    public void lauchGalleryBtnClicked() {
